...
-- ----------------------------
INSERT INTO `comprobante` VALUES (1, 'BOLETA', 'B001', '3', 'ACTIVO');
...
INSERT INTO `menu` VALUES (3, 'Reparaciones Tec.', 'mobile-alt', 'reparaciones/mantenimiento_reparacion.php', 1, 1, '2024-07-24 22:48:29', 3);
INSERT INTO `menu` VALUES (4, 'Terminar Repar.', 'hand-holding-usd', 'servicio/mantenimiento_servicio.php', 1, 1, '2024-07-24 22:49:27', 4);
...
INSERT INTO `menu` VALUES (7, 'Ventas', 'cash-register', 'venta/mantenimiento_venta.php', 1, 1, '2024-07-24 22:52:11', 7);
INSERT INTO `menu` VALUES (8, 'Clientes', 'user-friends', 'cliente/mantenimiento_cliente.php', 1, 1, '2024-07-24 22:53:19', 8);
...
INSERT INTO `menu` VALUES (17, 'Comprobantes', 'file', 'comprobante/mantenimiento_comprobante.php', 1, 1, '2024-07-23 00:05:36', 25);
INSERT INTO `menu` VALUES (18, 'Configuracion', 'building', 'configuracion/mantenimiento_configuracion.php', 1, 1, '2024-08-02 23:54:02', 23);
INSERT INTO `menu` VALUES (19, 'Reporte Reparaciones', 'file-alt', 'reporteservicio/mantenimiento_reporte_servicio.php', 1, 1, '2024-07-24 23:04:07', 15);
INSERT INTO `menu` VALUES (20, 'Reporte Gastos', 'file-alt', 'reportegasto/mantenimiento_reporte_gasto.php', 1, 1, '2024-07-24 23:04:33', 16);
...
) ENGINE = InnoDB AUTO_INCREMENT = 379 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_spanish_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `td_menu_detalle` VALUES (243, 1, 15, 'Si', '2024-08-02 23:58:57', 1, 'No', 'No', 'No', 0);
...
INSERT INTO `td_menu_detalle` VALUES (255, 2, 1, 'Si', '2024-08-07 00:25:31', 1, 'No', 'No', 'No', 0);
INSERT INTO `td_menu_detalle` VALUES (256, 2, 2, 'No', '2024-08-07 00:25:31', 1, 'No', 'No', 'No', 0);
INSERT INTO `td_menu_detalle` VALUES (257, 2, 3, 'No', '2024-08-07 00:25:31', 1, 'No', 'No', 'No', 0);
INSERT INTO `td_menu_detalle` VALUES (258, 2, 4, 'No', '2024-08-07 00:25:31', 1, 'No', 'No', 'No', 0);
...
INSERT INTO `td_menu_detalle` VALUES (319, 4, 3, 'Si', '2024-08-07 00:25:54', 1, 'No', 'No', 'No', 0);
...
INSERT INTO `td_menu_detalle` VALUES (356, 5, 9, 'Si', '2024-08-07 00:26:17', 1, 'No', 'No', 'No', 0);
...
-- Records of usuario
-- ----------------------------
INSERT INTO `usuario` VALUES (1, 'admin', '$2y$12$C.1yXkkqqs45tHKfUJC4UuOfpRhB5aEQjQkYNVlnbIH/GXCUbeawi', 'solo cambiar nombre no borrar', 1, 'controller/usuario/foto/IMG132202214564.jpg', 'ACTIVO');
...
BEGIN
SELECT 'Ingreso' AS tipo, pd.fecha as fecha, '1' as cantidad, NULL as nombre_u, NULL as compro
...
UNION ALL
select 'Reparación' as tipo, re.fecha as fecha, '1' as cantidad, NULL as nombre_u, NULL as compro FROM recep_equipo re WHERE re.serie = P_IMEI;
END
;;
delimiter ;
...
BEGIN
DECLARE CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM producto_detalle where producto_id = ID_P AND imei COLLATE utf8mb4_general_ci= IMEI_R );

if @CANTIDAD = 0 THEN

INSERT into producto_detalle (producto_id, imei, fecha, vendido)values(ID_P, IMEI_R, CURDATE(), 'No');
...
SELECT
	...
	configuracion.confi_codigo_pos,
...
delimiter ;;
CREATE PROCEDURE `SP_REGISTRAR_RECEPCION`(IN MONTO DECIMAL(10,2),IN IDCLIENTE INT, IN IDMOTIVO INT,IN ADELANTO DECIMAL (10,2) ,IN DEBE DECIMAL (10,2),IN ACCESORIOS VARCHAR(255), IN FENTREGA DATE, IN COD_REC VARCHAR(50), IN TECNICOID INT, IN USUA_ID INT)
BEGIN
INSERT INTO recepcion(cliente_id, motivo_id, rece_monto, rece_fregistro, rece_estado, rece_estatus, rece_adelanto, rece_debe, rece_concepto,rece_fentrega, rece_cod, marca_id, tecnico, usuario_registrador)
	VALUES(IDCLIENTE,   IDMOTIVO, MONTO,CURDATE(),'EN REPARACION','ACTIVO',ADELANTO,DEBE,ACCESORIOS,FENTREGA, COD_REC, 1, TECNICOID, USUA_ID);
	 SELECT LAST_INSERT_ID();
  ...
  IF USUAID IS NOT NULL THEN
        SELECT
            ...
            s.tecnico_servi,
						...
						ROUND((s.servicio_monto * 0.15), 2) AS iva,
						 CASE
								WHEN s.fpago_id = 2 THEN ROUND((s.servicio_monto - (s.servicio_monto * 0.15))* 0.045, 2) 
								ELSE 0
						END as comision,
						CASE
								WHEN s.fpago_id = 2 THEN  ROUND((s.servicio_monto - SUM(ri.precio_compra)- (s.servicio_monto * 0.15) - (s.servicio_monto - (s.servicio_monto * 0.15))* 0.045), 2)
								WHEN s.fpago_id = 1 THEN   ROUND((s.servicio_monto - SUM(ri.precio_compra) - (s.servicio_monto * 0.15)), 2)
								ELSE 0
						END as util,
						SUM(ri.precio_compra) as precio_compr
        ...
        FROM
            ...
            INNER JOIN cliente c ON r.cliente_id = c.cliente_id 
						...
						INNER JOIN recep_insumos ri ON r.rece_id = ri.rece_id
        WHERE 
